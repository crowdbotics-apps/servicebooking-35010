...
## Project Structure
    ...
    ├── servicebooking_35010  # Django project configurations
...
1. Clone this repo and `cd servicebooking_35010`
...
2. Clone this repo and `cd servicebooking_35010`
